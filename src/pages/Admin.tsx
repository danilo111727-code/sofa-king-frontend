            ...
            <form onSubmit={handleSave} className="px-6 py-5 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <Field label="Design Autoral (exibe selo exclusivo nos cards)">
                  <div className="flex items-center gap-2">
                    <button type="button" onClick={() => setForm({ ...form, designAutoral: true })} className={`flex-1 py-2 rounded-lg text-sm font-medium border ${form.designAutoral ? "bg-purple-900/50 border-purple-500 text-purple-300" : "bg-[#120d06] border-[#2d1f10] text-[#5a4030]"}`}>✏️ Sim</button>
